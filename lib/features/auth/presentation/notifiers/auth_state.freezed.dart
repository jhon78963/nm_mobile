...
class _AuthStateFailure implements AuthState {
  const _AuthStateFailure(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AuthStateFailureCopyWith<_AuthStateFailure> get copyWith => __$AuthStateFailureCopyWithImpl<_AuthStateFailure>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthStateFailure&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class _$AuthStateFailureCopyWith<$Res> implements $AuthStateCopyWith<$Res> {
  factory _$AuthStateFailureCopyWith(_AuthStateFailure value, $Res Function(_AuthStateFailure) _then) = __$AuthStateFailureCopyWithImpl;
@useResult
$Res call({
 String message
});
...
class __$AuthStateFailureCopyWithImpl<$Res>
  ...
  __$AuthStateFailureCopyWithImpl(this._self, this._then);

  final _AuthStateFailure _self;
  final $Res Function(_AuthStateFailure) _then;
